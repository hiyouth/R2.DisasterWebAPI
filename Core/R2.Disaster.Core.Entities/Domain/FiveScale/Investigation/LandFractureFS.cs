...
namespace R2.Disaster.CoreEntities.Domain.FiveScale.Investigation
{
    ...
    public partial class LandFractureFS:BaseEntity
    {
        ...
        public float? 单缝位移方向1 { get; set; }

        public float? 单缝位移距离1 { get; set; }

       
        public string 单缝填充物1 { get; set; }

        public int? 单缝出现时间年1 { get; set; }

        public int? 单缝出现时间月1 { get; set; }

        public int? 单缝出现时间日1 { get; set; }
        ...
        public float? 单缝位移方向2 { get; set; }

        public float? 单缝位移距离2 { get; set; }

       
        public string 单缝填充物2 { get; set; }

        public int? 单缝出现时间年2 { get; set; }

        public int? 单缝出现时间月2 { get; set; }

        public int? 单缝出现时间日2 { get; set; }
        ...
        public float? 单缝位移方向3 { get; set; }

        public float? 单缝位移距离3 { get; set; }

       
        public string 单缝填充物3 { get; set; }

        public int? 单缝出现时间年3 { get; set; }

        public int? 单缝出现时间月3 { get; set; }

        public int? 单缝出现时间日3 { get; set; }
        ...
        public float? 群缝分布面积 { get; set; }

        public float? 群缝发育间距 { get; set; }

       
        public string 群缝排列形式 { get; set; }

        public int? 群缝平行排列倾向 { get; set; }

        public int? 群缝平行排列倾角 { get; set; }

        public int? 群缝平行排列阶步指向 { get; set; }

        public int? 群缝斜列排列倾向 { get; set; }

        public int? 群缝斜列排列倾角 { get; set; }

        public int? 群缝斜列排列阶步指向 { get; set; }

       
        public string 群缝环围排列圆心位置经度 { get; set; }

       
        public string 群缝环围排列圆心位置纬度 { get; set; }

        public float? 裂缝长度max { get; set; }

        public float? 裂缝长度min { get; set; }

        public float? 裂缝宽度max { get; set; }

        public float? 裂缝宽度min { get; set; }

        public float? 裂缝深度max { get; set; }

        public float? 裂缝深度min { get; set; }
        ...
        public string 引发动力因素 { get; set; }

        public float? 洞室埋深 { get; set; }

       
        public string 洞室规模 { get; set; }

        public float? 洞室长 { get; set; }

        public float? 洞室宽 { get; set; }

        public float? 洞室高 { get; set; }

       
        public string 洞室与裂缝区位置关系 { get; set; }

        public int? 洞室开挖时间年 { get; set; }

        public int? 洞室开挖时间月 { get; set; }

        public int? 洞室开挖时间日 { get; set; }
        ...
        public float? 抽排井埋深 { get; set; }

        public float? 抽排水位 { get; set; }

        public float? 抽排水量 { get; set; }

        public float? 抽排日出水量 { get; set; }

       
        public string 抽排水位置关系 { get; set; }

        public int? 抽排水开始时间年 { get; set; }

        public int? 抽排水开始时间月 { get; set; }

        public int? 抽排水开始时间日 { get; set; }

        public int? 抽排水停止时间年 { get; set; }

        public int? 抽排水停止时间月 { get; set; }

        public int? 抽排水停止时间日 { get; set; }
        ...
        public int? 地震发生时间年 { get; set; }

        public int? 地震发生时间月 { get; set; }

        public int? 地震发生时间日 { get; set; }


        public bool 断层活动 { get; set; }
        ...
        public float? 活动断层长度 { get; set; }

       
        public string 活动断层性质 { get; set; }

        public int? 活动断层活动时间年 { get; set; }

        public int? 活动断层活动时间月 { get; set; }

        public int? 活动断层活动时间日 { get; set; }

        public float? 活动断层活动速率 { get; set; }

        public float? 活动断层断距 { get; set; }

       
        public string 水理作用水源 { get; set; }

        public int? 水理作用时间年 { get; set; }

        public int? 水理作用时间月 { get; set; }

        public int? 水理作用时间日 { get; set; }

        public float? 水理作用水质 { get; set; }


        public bool 开挖卸荷作用 { get; set; }


        public bool 其它作用引起的干湿变化 { get; set; }

       
        public string 水理作用类型 { get; set; }

        public int? 水理作用开挖时间年 { get; set; }

        public int? 水理作用开挖时间月 { get; set; }

        public int? 水理作用开挖时间日 { get; set; }

       
        public string 水理作用开挖方式 { get; set; }

        public float? 水理作用开挖深度 { get; set; }

        public float? 毁坏房屋 { get; set; }

        public float? 阻断交通 { get; set; }
        ...
        public float? 威胁房屋 { get; set; }

        public float? 交通隐患 { get; set; }
