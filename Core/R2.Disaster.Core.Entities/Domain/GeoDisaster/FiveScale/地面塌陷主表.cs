namespace Corner.Core
{
    ...
    public partial class 地面塌陷主表
    {
        ...
        public float? 单体陷坑充水水位深1 { get; set; }

        public float? 单体陷坑水位变动1 { get; set; }

        public int? 单体陷坑发生时间年1 { get; set; }

        public int? 单体陷坑发生时间月1 { get; set; }

        public int? 单体陷坑发生时间日1 { get; set; }

        public int? 单体陷坑发生时间时1 { get; set; }

        public int? 单体陷坑发生时间分1 { get; set; }

        public int? 单体陷坑发生时间秒1 { get; set; }
        ...
        public float? 单体陷坑充水水位深2 { get; set; }

        public float? 单体陷坑水位变动2 { get; set; }

        public int? 单体陷坑发生时间年2 { get; set; }

        public int? 单体陷坑发生时间月2 { get; set; }

        public int? 单体陷坑发生时间日2 { get; set; }

        public int? 单体陷坑发生时间时2 { get; set; }

        public int? 单体陷坑发生时间分2 { get; set; }

        public int? 单体陷坑发生时间秒2 { get; set; }
        ...
        public float? 单体陷坑充水水位深3 { get; set; }

        public float? 单体陷坑水位变动3 { get; set; }

        public int? 单体陷坑发生时间年3 { get; set; }

        public int? 单体陷坑发生时间月3 { get; set; }

        public int? 单体陷坑发生时间日3 { get; set; }

        public int? 单体陷坑发生时间时3 { get; set; }

        public int? 单体陷坑发生时间分3 { get; set; }

        public int? 单体陷坑发生时间秒3 { get; set; }
        ...
        public float? 最小陷坑口径 { get; set; }

        public float? 最大陷坑口径 { get; set; }

        public float? 最小陷坑深度 { get; set; }

        public float? 最大陷坑深度 { get; set; }

        public int? 始发时间年 { get; set; }

        public int? 始发时间月 { get; set; }

        public int? 始发时间日 { get; set; }

        public int? 盛发开始时间年 { get; set; }

        public int? 盛发开始时间月 { get; set; }

        public int? 盛发开始时间日 { get; set; }

        public int? 盛发截止时间年 { get; set; }

        public int? 盛发截止时间月 { get; set; }

        public int? 盛发截止时间日 { get; set; }

        public int? 停止时间年 { get; set; }

        public int? 停止时间月 { get; set; }

        public int? 停止时间日 { get; set; }
        ...
        public float? 单缝长度1 { get; set; }

        public float? 单缝宽度1 { get; set; }

        public float? 单缝深度1 { get; set; }
        ...
        public float? 单缝长度2 { get; set; }

        public float? 单缝宽度2 { get; set; }

        public float? 单缝深度2 { get; set; }
        ...
        public float? 单缝长度3 { get; set; }

        public float? 单缝宽度3 { get; set; }

        public float? 单缝深度3 { get; set; }
        ...
        public float? 裂缝分布面积 { get; set; }

        public float? 裂缝间距 { get; set; }
        ...
        public float? 裂缝长max { get; set; }

        public float? 裂缝长min { get; set; }

        public float? 裂缝宽max { get; set; }

        public float? 裂缝宽min { get; set; }

        public float? 裂缝深max { get; set; }

        public float? 裂缝深min { get; set; }
        ...
        public float? 岩溶塌陷塌顶溶洞埋深 { get; set; }

        public float? 岩溶塌陷地下水位埋深 { get; set; }
        ...
        public float? 土洞塌陷单层土厚 { get; set; }

       
        public string 土洞塌陷双层上部土性 { get; set; }

        public float? 土洞塌陷双层上部土厚 { get; set; }

       
        public string 土洞塌陷双层下部土性 { get; set; }

        public float? 土洞塌陷双层下部土厚 { get; set; }
        ...
        public float? 土洞塌陷地下水位埋深 { get; set; }
        ...
        public float? 井位塌陷区距离 { get; set; }

        public float? 井位塌陷区抽水降深 { get; set; }

        public float? 井位塌陷区日出水量 { get; set; }

       
        public string 江河水位塌陷区方向 { get; set; }

        public float? 江河水位塌陷区距离 { get; set; }

        public float? 江河水位塌陷区水位变幅 { get; set; }
        ...
        public float? 冒顶塌陷岩层厚度 { get; set; }

        public float? 冒顶塌陷地下水位埋深 { get; set; }

       
        public string 冒顶塌陷诱发动力因素 { get; set; }

        public float? 冒顶塌陷矿层厚度 { get; set; }

        public int? 冒顶塌陷开采时间年 { get; set; }

        public int? 冒顶塌陷开采时间月 { get; set; }

        public int? 冒顶塌陷开采时间日 { get; set; }

        public float? 冒顶塌陷开采厚度 { get; set; }

        public float? 冒顶塌陷开采深度 { get; set; }

       
        public string 冒顶塌陷开采方法 { get; set; }

        public float? 冒顶塌陷工作面推进速度 { get; set; }

        public float? 冒顶塌陷采出量 { get; set; }
        ...
        public float? 毁坏田地 { get; set; }

        public float? 毁坏房屋 { get; set; }

        public float? 阻断铁路 { get; set; }

        public float? 阻断公路 { get; set; }

        public float? 阻断通讯 { get; set; }

       
        public string 阻断交通 { get; set; }

        public float? 河水流量减少 { get; set; }

        public float? 断流 { get; set; }

        public float? 井泉水流量减少 { get; set; }

        public float? 水位降低 { get; set; }

       
        public string 地下水源枯竭 { get; set; }

        public float? 水量增大 { get; set; }

        public double? 成灾损失 { get; set; }

        public double? 淹井损失 { get; set; }
        ...
        public float? 扩大陷区 { get; set; }

        public float? 潜在毁田 { get; set; }

        public int? 潜在毁房 { get; set; }

        public int? 出现新陷区 { get; set; }

        public float? 新陷区面积 { get; set; }

        public float? 断路 { get; set; }
