...
namespace R2.Disaster.CoreEntities.Domain.GeoDisaster.Emergency
{
    ...
    public partial class EmergencySurvey
    {
        ...
        public Nullable<double> 前缘高程 { get; set; }
        public Nullable<double> 后缘高程 { get; set; }
        public string 地层岩性 { get; set; }
        public string 地质构造 { get; set; }
        public Nullable<double> 多年平均降雨量 { get; set; }
        public Nullable<double> 长 { get; set; }
        public Nullable<double> 宽 { get; set; }
        public Nullable<double> 高 { get; set; }
        public Nullable<double> 面积 { get; set; }
        public Nullable<double> 体积 { get; set; }
