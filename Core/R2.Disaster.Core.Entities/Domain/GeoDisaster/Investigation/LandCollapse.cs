...
namespace R2.Disaster.CoreEntities.Domain.GeoDisaster.Investigation
{
    ...
    public partial class LandCollapse
    {
        ...
        public Nullable<float> 单体陷坑深度1 { get; set; }
        public Nullable<float> 单体陷坑变形面积1 { get; set; }
        public string 单体陷坑规模等级1 { get; set; }
        public string 单体陷坑长轴方向1 { get; set; }
        public Nullable<float> 单体陷坑充水水位深1 { get; set; }
        public Nullable<float> 单体陷坑水位变动1 { get; set; }
        public string 单体陷坑发生时间1 { get; set; }
        public string 单体陷坑发展变化1 { get; set; }
        public Nullable<int> 单体陷坑坑号2 { get; set; }
        public string 单体陷坑形状2 { get; set; }
        public Nullable<float> 单体陷坑坑口规模2 { get; set; }
        public Nullable<float> 单体陷坑深度2 { get; set; }
        public Nullable<float> 单体陷坑变形面积2 { get; set; }
        public string 单体陷坑规模等级2 { get; set; }
        public string 单体陷坑长轴方向2 { get; set; }
        public Nullable<float> 单体陷坑充水水位深2 { get; set; }
        public Nullable<float> 单体陷坑水位变动2 { get; set; }
        public string 单体陷坑发生时间2 { get; set; }
        public string 单体陷坑发展变化2 { get; set; }
        public Nullable<int> 单体陷坑坑号3 { get; set; }
        public string 单体陷坑形状3 { get; set; }
        public Nullable<float> 单体陷坑坑口规模3 { get; set; }
        public Nullable<float> 单体陷坑深度3 { get; set; }
        public Nullable<float> 单体陷坑变形面积3 { get; set; }
        public string 单体陷坑规模等级3 { get; set; }
        public string 单体陷坑长轴方向3 { get; set; }
        public Nullable<float> 单体陷坑充水水位深3 { get; set; }
        public Nullable<float> 单体陷坑水位变动3 { get; set; }
        public string 单体陷坑发生时间3 { get; set; }
        public string 单体陷坑发展变化3 { get; set; }
        public Nullable<int> 陷坑坑数 { get; set; }
        public string 陷坑分布面积 { get; set; }
        public string 排列形式 { get; set; }
        public string 长列方向 { get; set; }
        public Nullable<float> 最小陷坑口径 { get; set; }
        public Nullable<float> 最大陷坑口径 { get; set; }
        public Nullable<float> 最小陷坑深度 { get; set; }
        public Nullable<float> 最大陷坑深度 { get; set; }
        ...
        public Nullable<int> 单缝缝号1 { get; set; }
        public string 单缝形态1 { get; set; }
        public string 单缝延伸方向1 { get; set; }
        public Nullable<int> 单缝倾向1 { get; set; }
        public Nullable<int> 单缝倾角1 { get; set; }
        public Nullable<float> 单缝长度1 { get; set; }
        public Nullable<float> 单缝宽度1 { get; set; }
        public Nullable<float> 单缝深度1 { get; set; }
        public string 单缝性质1 { get; set; }
        public Nullable<int> 单缝缝号2 { get; set; }
        public string 单缝形态2 { get; set; }
        public string 单缝延伸方向2 { get; set; }
        public Nullable<int> 单缝倾向2 { get; set; }
        public Nullable<int> 单缝倾角2 { get; set; }
        public Nullable<float> 单缝长度2 { get; set; }
        public Nullable<float> 单缝宽度2 { get; set; }
        public Nullable<float> 单缝深度2 { get; set; }
        public string 单缝性质2 { get; set; }
        public Nullable<int> 单缝缝号3 { get; set; }
        public string 单缝形态3 { get; set; }
        public string 单缝延伸方向3 { get; set; }
        public Nullable<int> 单缝倾向3 { get; set; }
        public Nullable<int> 单缝倾角3 { get; set; }
        public Nullable<float> 单缝长度3 { get; set; }
        public Nullable<float> 单缝宽度3 { get; set; }
        public Nullable<float> 单缝深度3 { get; set; }
        public string 单缝性质3 { get; set; }
        public Nullable<int> 缝数 { get; set; }
        public Nullable<float> 裂缝分布面积 { get; set; }
        public Nullable<float> 裂缝间距 { get; set; }
        public string 裂缝排列形式 { get; set; }
        public Nullable<int> 裂缝倾向 { get; set; }
        public Nullable<int> 裂缝倾角 { get; set; }
        public Nullable<float> 裂缝长max { get; set; }
        public Nullable<float> 裂缝长min { get; set; }
        public Nullable<float> 裂缝宽max { get; set; }
        public Nullable<float> 裂缝宽min { get; set; }
        public Nullable<float> 裂缝深max { get; set; }
        public Nullable<float> 裂缝深min { get; set; }
        public string 塌陷区地貌特征 { get; set; }
        public string 成因类型 { get; set; }
        public string 岩溶塌陷地层时代 { get; set; }
        public string 岩溶塌陷地层岩性 { get; set; }
        public Nullable<int> 岩溶塌陷岩层倾向 { get; set; }
        public Nullable<int> 岩溶塌陷岩层倾角 { get; set; }
        public string 岩溶塌陷断裂情况 { get; set; }
        public string 岩溶塌陷溶洞发育情况 { get; set; }
        public string 岩溶塌陷岩层发育程度 { get; set; }
        public Nullable<float> 岩溶塌陷塌顶溶洞埋深 { get; set; }
        public Nullable<float> 岩溶塌陷地下水位埋深 { get; set; }
        public string 岩溶塌陷诱发动力因素 { get; set; }
        public string 土洞塌陷单层土性 { get; set; }
        public Nullable<float> 土洞塌陷单层土厚 { get; set; }
        public string 土洞塌陷双层上部土性 { get; set; }
        public Nullable<float> 土洞塌陷双层上部土厚 { get; set; }
        public string 土洞塌陷双层下部土性 { get; set; }
        public Nullable<float> 土洞塌陷双层下部土厚 { get; set; }
        public string 土洞塌陷下伏基岩时代 { get; set; }
        public string 土洞塌陷下伏基岩岩性 { get; set; }
        public Nullable<float> 土洞塌陷地下水位埋深 { get; set; }
        public string 土洞塌陷诱发动力因素 { get; set; }
        public string 井位塌陷区方向 { get; set; }
        public Nullable<float> 井位塌陷区距离 { get; set; }
        public Nullable<float> 井位塌陷区抽水降深 { get; set; }
        public Nullable<float> 井位塌陷区日出水量 { get; set; }
        public string 江河水位塌陷区方向 { get; set; }
        public Nullable<float> 江河水位塌陷区距离 { get; set; }
        public Nullable<float> 江河水位塌陷区水位变幅 { get; set; }
        public string 江河水位塌陷区变化类型 { get; set; }
        public string 冒顶塌陷土层时代 { get; set; }
        public string 冒顶塌陷土层土性 { get; set; }
        public Nullable<float> 冒顶塌陷土层厚度 { get; set; }
        public string 冒顶塌陷岩层时代 { get; set; }
        public string 冒顶塌陷岩层岩性 { get; set; }
        public Nullable<float> 冒顶塌陷岩层厚度 { get; set; }
        public Nullable<float> 冒顶塌陷地下水位埋深 { get; set; }
        public string 冒顶塌陷诱发动力因素 { get; set; }
        public Nullable<float> 冒顶塌陷矿层厚度 { get; set; }
        public string 冒顶塌陷开采时间 { get; set; }
        public Nullable<float> 冒顶塌陷开采厚度 { get; set; }
        public Nullable<float> 冒顶塌陷开采深度 { get; set; }
        public string 冒顶塌陷开采方法 { get; set; }
        public Nullable<float> 冒顶塌陷工作面推进速度 { get; set; }
        public Nullable<float> 冒顶塌陷采出量 { get; set; }
        ...
        public Nullable<float> 毁坏田地 { get; set; }
        public Nullable<float> 毁坏房屋 { get; set; }
        ...
        public Nullable<int> 潜在毁房 { get; set; }
        public Nullable<int> 出现新陷区 { get; set; }
