...
{
    public class GHLandCollapseMap : EntityTypeConfiguration<GHLandCollapse>
    {
        public GHLandCollapseMap()
        {
            this.ToTable("GHLandCollapses");
            this.HasKey(c => c.Id);
            ...
            this.HasRequired(c => c.GHComprehensive)
                .WithRequiredDependent(c => c.GHLandCollapse);
        }
    }
}
