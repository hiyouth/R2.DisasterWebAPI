...
{
    public class GHDebrisFlowMap : EntityTypeConfiguration<GHDebrisFlow>
    {
        public GHDebrisFlowMap()
        {
            this.ToTable("GHDebrisFlows");
            this.HasKey(c => c.Id);
            ...
            this.HasRequired(c => c.GHComprehensive)
                .WithRequiredDependent(c => c.GHDebrisFlow);
        }
    }
}
