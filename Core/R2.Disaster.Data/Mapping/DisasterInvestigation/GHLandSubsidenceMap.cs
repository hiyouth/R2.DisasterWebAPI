...
{
    public class GHLandSubsidenceMap : EntityTypeConfiguration<GHLandSubsidence>
    {
        public GHLandSubsidenceMap()
        {
            this.ToTable("GHLandSubsidences");
            this.HasKey(c => c.Id);
            ...
            this.HasRequired(c => c.GHComprehensive)
                .WithRequiredDependent(c => c.GHLandSubsidence);
        }
    }
}
